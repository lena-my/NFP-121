        ...
        while (jeu.getNombreAllumettes() > 0) {
            try {
                ...
                if (jeu.getNombreAllumettes() == 0) {
                    ...
                    // Pour les stratégies Swing, fermer les fenêtres
                    if (j1.strategie instanceof StrategieSwing s1) {
                        s1.fermerFenetre();
                    }
                    if (j2.strategie instanceof StrategieSwing s2) {
                        s2.fermerFenetre();
                    }
                    break;
            ...
            // Ajout d'une pause pour rendre le jeu plus fluide
            try {
                Thread.sleep(100); // 100 ms pause entre les tours
